...
if (!projectId || !dataset || !token) {
  ...
  console.error(
    "Make sure NEXT_PUBLIC_SANITY_PROJECT_ID, NEXT_PUBLIC_SANITY_DATASET, and SANITY_API_WRITE_TOKEN are set in .env.local",
  );
  process.exit(1);
}
...
async function seed() {
  ...
  await client.createOrReplace({
    ...
    heroStatement:
      "Seven years turning complexity into clarity — one screen at a time. From university portals to ride-hailing apps.",
    ...
    statsBar: [
      ...
      },
      {
        _key: "s3",
        label: "Get in touch",
        value: "yohanesalemu0069@gmail.com\n+251 922 802 813",
      },
    ],
    ...
    steps: [
      {
        ...
        title: "Discover",
        description:
          "User interviews, stakeholder workshops, competitive audits. Understand people deeply before touching Figma.",
      ...
      },
      {
        ...
        title: "Define",
        description:
          "User flows, information architecture, personas. A real design brief before a single screen exists.",
      ...
      },
      {
        ...
        title: "Design",
        description:
          "Wireframes to high-fidelity. Building the design system alongside the product — not as an afterthought.",
      ...
      },
      {
        ...
        title: "Test",
        description:
          "Real prototypes, real users. Usability sessions and iteration until it is genuinely right — not merely approved.",
      ...
      },
      {
        ...
        title: "Deliver",
        description:
          "Dev-ready Figma specs, documentation, and ongoing collaboration through build to protect the design vision.",
        tools: ["Handoff Phase"],
      },
    ],
  });
  ...
  await client.createOrReplace({
    ...
    name: "Yohanes Alemu",
    pullQuote:
      "Great design is the kind nobody notices — they just feel completely at home.",
    ...
    timeline: [
      ...
      },
      {
        _key: "t2",
        year: "2022 →",
        role: "Designer + Backend Dev",
        company: "Milto Tech · Addis Ababa",
      },
      {
        _key: "t3",
        year: "2018–23",
        role: "Head of Design Team",
        company: "Backos Technologies",
      },
      {
        _key: "t4",
        year: "2022",
        role: "Intern — UI/UX + Dev",
        company: "ASTU STEM Center",
      },
      {
        _key: "t5",
        year: "2017 →",
